...
INSTCMD_protoc-gen-go := google.golang.org/protobuf/cmd/protoc-gen-go@v1.36.12
INSTCMD_protoc-gen-go-grpc := google.golang.org/grpc/cmd/protoc-gen-go-grpc@v1.6.2
INSTCMD_staticcheck := honnef.co/go/tools/cmd/staticcheck@2026.2.1
